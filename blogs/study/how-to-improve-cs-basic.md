...
可能有经验的同学，用递归的方式很容易就解出来了。但是，你有想过如何用非递归的方式吗？如果能用非递归来是实现一遍，相信给自己带来的帮助和提升会比递归解大得多。而对于刷题的同学，无非追求两样东西，一是**让代码通过**，二是**增加题量**。但与真正的练习相比，哪一个对自己帮助更大呢？明显是后者，虽然短期内它带来的快感和成就感不如刷题来的明显。
